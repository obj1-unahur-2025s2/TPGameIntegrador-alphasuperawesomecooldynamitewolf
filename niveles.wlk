...
const nivel2= new Nivel(musica=game.sound("coldOrcs.mp3"),nivel=2,dificultad =2, enemigosPorOleada=8, cantidadDeRey=3,ubicacionesCamino = [[19,5],[18,5],[17,5],[16,4],[16,3],[16,2],[15,2],[14,2],[13,2],[12,2],[11,2],[10,2],[9,2],[8,2],[8,1],[8,0]], ubicacionesPosiblesDeTorre = [[8,3],[11,0],[11,3],[16,0],[14,4],[16,6]], pantalla=nivelDosFondo) //un nivel para probar diseños. --cambiar a tutorial mas adelante
